...
public class RegularPolygon {
	...
	//data fields with polygon atributes
	private int n = 3;
	...
	//Constructor that creates polygon with specified sides and position
	...
	//Constructor that creates polygon with specified sides and coordinates
	...
	/**
	 * Method returns calculated perimeter of r.polygon 
	 * @return
	 */
	public double getPerimeter(){
		double perimeter = getN() * getSide();
		return perimeter;
	}
	
	/**
	 * Method returns calculated area of r.polygon 
	 * @return
	 */
